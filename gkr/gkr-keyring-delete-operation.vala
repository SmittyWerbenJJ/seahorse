...
public class Seahorse.Gkr.KeyringDeleteOperation : DeleteOperation {
    ...
    protected override Adw.MessageDialog create_confirm_dialog(Gtk.Window? parent) {
        var dialog = base.create_confirm_dialog(parent);
        dialog.body = _("All items in the items will also be permanently deleted!");
        return dialog;
    }
