...
public abstract class Seahorse.DeleteOperation : GLib.Object, GLib.ListModel {
    ...
    public async bool execute_interactively(Gtk.Window? parent,
                                            ...
                                            throws GLib.Error {
        var dialog = create_confirm_dialog(parent);
        unowned var response = yield dialog.choose(cancellable);
        if (response != "delete")
    ...
    protected virtual Adw.MessageDialog create_confirm_dialog(Gtk.Window? parent) {
